...
@keyframes skeleton-shimmer {
    ...
    100% {
...
}`;const m={COMPANY:`company`,CONFIG:`config`,RESULT:`result`,SERVICE:`service`,METAGORA:`metagora`,SEARCH:`search`,FILTER:`filter`,MODAL:`modal`,CHAT:`chat`};var te=class extends i{companyContext;constructor(){super(`plain-logo`,ee),this.companyContext=this.useContext(m.COMPANY,!0)}renderSkeletonLoader(){return this.html`
        ...
        `:this.renderSkeletonLoader()}};window.customElements.define(`plain-logo`,te);var ne=`.plain-nav-menu-wrapper {
    width: 100%;
    height: fit-content;
} 
...
`};var pe=class extends i{companyContext;constructor(){super(`plain-nav-item`,re),this.companyContext=this.useContext(`company`)}showTooltip(e){let t=e.currentTarget,n=t.querySelector(`.tooltip`);if(!n)return;let r=t.getBoundingClientRect();n.style.position=`fixed`,n.style.top=`${r.top-n.offsetHeight-8}px`,n.style.left=`${r.left+r.width/2-n.offsetWidth/2}px`,n.style.visibility=`visible`,n.style.opacity=`1`}hideTooltip(e){let t=e.currentTarget.querySelector(`.tooltip`);t&&(t.style.visibility=`hidden`,t.style.opacity=`0`)}template(){let e=this.props.mainUrl?this.html`
                ...
                >
                    ...
                    ${this.props.mainUrl?this.html`<span class="nav-arrow">${_}</span>`:``}
        ...
        `}};window.customElements.define(`plain-nav-item`,pe);var me=`.plain-catalogue-item-wrapper {
    display: block;
}
...
.label.disabled {
    color: #a8a8a8;
}`,he=class extends i{configContext;metagoraContext;constructor(){super(`plain-catalogue-item`,me),this.configContext=this.useContext(m.CONFIG,!0),this.metagoraContext=this.useContext(m.METAGORA,!0)}template(){let e=this.configContext.get(`IS_METAGORA`),t=e?(this.metagoraContext.get(`agoras`)||[]).find(e=>e.name===this.props.companyName):void 0,n=`${e?t?.host:this.configContext.get(`API_HOST`)}${this.props.url}`;return e&&!t?this.html`
...
`}</span>
        ...
        `}};window.customElements.define(`plain-catalogue-item`,he);var ge=class extends i{serviceContext;companyContext;constructor(){super(`plain-nav-menu`,ne),this.serviceContext=this.useContext(m.SERVICE,!0),this.companyContext=this.useContext(m.COMPANY,!0)}renderSkeletonLoader(){let e=[,,,,].fill(null).map((e,t)=>this.html`
        ...
        `}template(){let e=this.serviceContext.get(`services`);return!e||e.length===0?this.renderSkeletonLoader():this.html`
            ${e.map(t=>{let n=t.fields.catalogues.websites,r=n&&n.length>0,i=t.fields.main_url&&t.fields.main_url!==`False`?t.fields.main_url:``,a=this.html`
                ...
                `:this.html`
                    ...
                    `}).join(`
`)}
        `}};window.customElements.define(`plain-nav-menu`,ge);var _e=`.plain-metagora-nav-menu-wrapper {
    width: 100%;
    height: fit-content;
} 
...
@keyframes loading {
    ...
    100% {
...
} `;function x(e){if(!e||typeof e!=`string`)return null;try{let t=[],n=e.replace(/\bTrue\b/g,`true`).replace(/\bFalse\b/g,`false`).replace(/\bNone\b/g,`null`).replace(/"((?:[^"\\]|\\.)*)"/g,(e,n)=>(t.push(n),`<<<${t.length-1}>>>`)).replace(/'((?:[^'\\]|\\.)*)'/g,(e,t)=>`"${t.replace(/\\'/g,`'`).replace(/"/g,`\\"`)}"`).replace(/<<<(\d+)>>>/g,(e,n)=>`"${t[parseInt(n)]}"`);return JSON.parse(n)}catch(t){return console.warn(`Failed to parse Python object to JSON:`,e,t),null}}function ve(e){if(!e||typeof e!=`string`||!e.startsWith(`[`)||e===`[]`)return null;let t=x(e);if(!t)return null;if(Array.isArray(t)&&t.length>0){let e=t[0];if(typeof e==`object`&&e&&`name`in e)return t.map(e=>e.name||e.display_name||``).filter(e=>e!==``)}return null}function S(e){if(!e)return[];if(Array.isArray(e))return e.map(e=>{if(typeof e==`object`&&e){let t=e.name||e.display_name||``;if(!t)return null;let n=t.match(/^\(([^)]+)\)/);return n?n[1]:t}if(typeof e==`string`){let t=e.match(/^\(([^)]+)\)/);return t?t[1]:e}return null}).filter(e=>e!==null&&e!==``);if(typeof e==`string`){if(e.startsWith(`[`)){let t=x(e);if(t)return S(t)}let t=e.match(/^\(([^)]+)\)/);return t?[t[1]]:[e]}if(typeof e==`object`&&e){let t=e.name||e.display_name||``;if(!t)return[];let n=t.match(/^\(([^)]+)\)/);return n?[n[1]]:[t]}return[]}function C(e){return e&&e.startsWith(`as_`)?e.substring(3).replace(/_/g,` `).split(` `).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(` `):`Other`}function ye(e){if(!e)return``;let t=document.createElement(`div`);return t.innerHTML=e,t.textContent||t.innerText||``}var be=class extends i{serviceContext;metagoraContext;searchQuery=``;selectedCompany=null;searchTimeout=null;constructor(){super(`plain-metagora-nav-menu`,_e),this.serviceContext=this.useContext(m.SERVICE,!0),this.metagoraContext=this.useContext(m.METAGORA,!0)}handleSearch(e){let t=e.target.value.toLowerCase();this.searchTimeout&&clearTimeout(this.searchTimeout),this.searchTimeout=window.setTimeout(()=>{this.searchQuery=t,this.updateList()},300)}handleCompanyFilter(e){this.selectedCompany===e?this.selectedCompany=null:this.selectedCompany=e,this.updateList(),this.updateFilterChips()}updateList(){let e=this.$(`#services-list`);e&&(e.innerHTML=this.getServicesListHTML())}updateFilterChips(){(this.shadowRoot?.querySelectorAll(`.filter-chip`))?.forEach(e=>{let t=e.getAttribute(`data-company`);t===this.selectedCompany||t===`all`&&this.selectedCompany===null?e.classList.add(`active`):e.classList.remove(`active`)})}renderSkeletonLoader(){let e=[,,,,].fill(null).map((e,t)=>this.html`
            <div class="skeleton-item">
                <div class="skeleton-icon"></div>
                <div class="skeleton-text" style="width: ${70+t*10%30}%"></div>
            </div>
        ...
        `}};window.customElements.define(`plain-metagora-nav-menu`,be);var xe=`.plain-greetings-wrapper {
    box-sizing: border-box;
...
@keyframes slideUpFade {
    ...
    to {
        ...
        `}};window.customElements.define(`plain-greetings`,Se);var Ce=`.plain-carousel-wrapper {
    height: 100%;
...
@keyframes gradient {
    ...
    100% {
                ...
                <div class="slide">
                    ...
                    <div class="content">
                        ...
                        <div class="search-terms anim-slide-text">
                            ${a&&a.split(`,`).slice(0,3).map(e=>`<span>#${e.trim()}</span>`).join(` `)}
                        </div>
                        <a 
                            href="${d?o:`#`}"
                            target="_blank"
        ...
        `}listeners(){let e=this.$$(`.dot`);e&&e.forEach((e,t)=>{e.onclick=()=>this.setSlide(t)})}};window.customElements.define(`plain-carousel`,we);var Te=`.plain-metagora-hero-wrapper {
    width: 100%;
    height: 100%;
    position: relative;
...
}`,Ee=class extends i{metagoraContext;words=[`Explore`,`Transform`,`Empower`,`Accelerate`,`Bound`,`Innovate`];currentWordIndex=0;intervalId=null;wordElement=null;constructor(){super(`plain-metagora-hero`,Te),this.metagoraContext=this.useContext(m.METAGORA,!0)}template(){let e=this.metagoraContext.get(`agoras`)||[];return this.html`
            ...
            <section class="metagora-hero--content">
                <div class="metagora-hero--left">
                    ...
                    <div class="metagora-hero--cta-container">
                        ...
                        >
                            Know more about us
                            <span class="metagora-hero--cta-icon">${_}</span>
                        </a>
...
}`;function ke(e,t){return e?e.startsWith(`http://`)||e.startsWith(`https://`)?e:`${t}${e}`:``}function Ae(e,t,n,r,i){if(!e||!t)return i||`#`;let a=n.filter(e=>e._sourceHost===r);for(let n of a){let i=n.fields?.catalogues?.websites||[];for(let n of i)if(n.model===e)return`${r}/offering/${n.view_id}/${t}`}for(let i of n){let n=i.fields?.catalogues?.websites||[];for(let i of n)if(i.model===e)return`${r}/offering/${i.view_id}/${t}`}return i||`#`}function je(e,t=1){let n=e.startsWith(`#`)?e.slice(1):e,r=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),a=parseInt(n.slice(4,6),16);return`rgba(${r}, ${i}, ${a}, ${t})`}function Me(e,t,n){if(!e||!t||t.length===0)return e;let r=e;return[...t].sort((e,t)=>t.length-e.length).forEach(e=>{if(!e)return;let t=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),i=RegExp(`\\b(${t}\\w*)`,`gi`),a=n.startsWith(`#`)?je(n,.2):`${n}33`;r=r.replace(i,`<mark style="background-color: ${a};">$1</mark>`)}),r}var Ne=`.score-badge {
    display: flex;
    align-items: center;
    gap: 0.375rem;
    background-color: #f3f4f6;
...
`,Pe=class extends i{constructor(){super(`plain-score-badge`,Ne)}get score(){let e=this.props.score;if(e==null||e===`null`||e===``)return null;let t=parseFloat(e);return isNaN(t)?null:t}get aiPickTitle(){return this.props.aiPickTitle||`Suggested by AI assistant`}get matchTitle(){return this.props.matchTitle||`This is the relevance of the result`}template(){let e=this.score;return e===null?this.html`
        ...
        `}};window.customElements.define(`plain-score-badge`,Pe);var Fe=class extends i{result;configContext;serviceContext;modalContext;companyContext;constructor(){super(`plain-dynamic-card`,Oe),this.configContext=this.useContext(m.CONFIG),this.serviceContext=this.useContext(m.SERVICE),this.modalContext=this.useContext(m.MODAL),this.companyContext=this.useContext(m.COMPANY),this.result=JSON.parse(this.props.result)}getDetailUrl(){let e=this.result?._sourceHost||this.configContext.get(`API_HOST`);return Ae(this.result?.model,this.result?.data?.id,this.serviceContext.get(`services`)||[],e,this.result?.model_view_url)}getCardType(){let e=this.result?.data;if(!e)return`minimal`;let t=e?.name||e?.display_name,n=e?.x_summary||e?.x_description,r=e?.x_image,i=e?.x_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities,a=e?.x_web_link||e?.x_link||e?.x_more_info||e?.x_additional_link,o=this.result?.model_view_url;return t&&n&&r&&i&&a&&o?`full`:t&&n?`medium`:`minimal`}extractFullCard(){let e=this.result.data,t=e?.x_origin||e?.x_university_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities||``;return{score:this.result.score?.relative??null,image_url:e?.x_image||``,origins:S(t),name:e?.display_name||e?.name||``,summary:e?.x_summary||e?.x_description?ye(e.x_summary||e.x_description):``,model_name:this.result?.model_verbose_name||``,detail_url:this.getDetailUrl(),additional_url:e?.x_web_link||e?.x_link||e?.x_more_info||e?.x_additional_link||``,catalogue_url:this.result.model_view_url||``}}extractMediumCard(){let e=this.result.data,t=e?.x_origin||e?.x_university_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities,n=t?S(t):[];return{score:this.result.score?.relative??null,origins:n.length>0?n:void 0,name:e?.display_name||e?.name||``,summary:e?.x_summary||e?.x_description?ye(e.x_summary||e.x_description):``,model_name:this.result?.model_verbose_name||``,detail_url:this.getDetailUrl(),catalogue_url:this.result.model_view_url,additional_url:e?.x_web_link||e?.x_link||e?.x_more_info||e?.x_additional_link}}extractMinimalCard(){let e=this.result.data,t=e?.x_origin||e?.x_university_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities,n=t?S(t):[],r=this.result.score?.relative??null;return{name:e?.display_name||e?.name||`Untitled`,score:r,model_name:this.result?.model_verbose_name||``,origins:n.length>0?n:void 0}}getHighlightedText(e){let t=this.result?.roots||[],n=this.companyContext.get(`primaryColor`)||`#8238eb`;return Me(e,t,n)}renderFullCard(){let e=this.extractFullCard(),t=this.result?._sourceHost||this.configContext.get(`API_HOST`),n=e.origins.length>0?e.origins.map(e=>this.html`
            ...
            <div class="card full-card">
                ${e.image_url?this.html`
                        <div class="card-image-container">
                            <div 
                                class="card-image" 
                                style="background-image: url('${ke(e.image_url,t)}')"
                            ></div>
                        </div>
                    `:``}
...
`;const w={RESULTS_FETCHED:`results-fetched`,RESULTS_CLEARED:`results-cleared`,CHAT_STARTED:`chat-started`,CHAT_USER_MESSAGE:`chat-user-message`,CHAT_MESSAGE_CHUNK:`chat-message-chunk`,CHAT_MESSAGE_COMPLETE:`chat-message-complete`,CHAT_RESULTS_UPDATED:`chat-results-updated`,CHAT_FETCHING_RESULTS:`chat-fetching-results`,NEW_CHAT:`new-chat`,MODE_SWITCH:`mode-switch`};function Ge(e){return e.length&&Math.max(...e.map(e=>e.score))||1}function Ke(e,t){let n=e.filter(e=>e.service===t);return n.length&&Math.max(...n.map(e=>e.score))||1}function qe(e,t,n=.1){return e.filter(e=>e.score[t]>=n)}function Je(e,t){e.forEach(e=>{let n=t.find(t=>t.models.includes(e.model));n?(e.service=n.service,e.serviceCategory=n.category):(console.warn(`No service found for model: ${e.model}`),e.service=`unknown`,e.serviceCategory=`Other`)})}function Ye(e,t,n){let r=Ge(e);return e.sort((e,t)=>t.score-e.score).map(i=>{let a=t.find(e=>e.model===i.model),o=a?.name||i.model,s=a?.website,c=a?.url,l=i._sourceHost||n,u=s?`${s}${c}`:`${l}${c}`,d=Ke(e,i.service);return{model:i.model,model_verbose_name:o,model_view_url:u,service:i.service,serviceCategory:i.serviceCategory||`Other`,featured_fields:i.featured_fields||[`web_link`,`url`,`website`],featured:i.featured||!1,data:i.data,roots:i.roots,score:{absolute:Number((i.score/r).toFixed(2)),relative:Number((i.score/d).toFixed(2))},_sourceHost:i._sourceHost}})}function Xe(e){return[...new Set(e.map(e=>e.service))].sort().map(t=>{let n=e.filter(e=>e.service===t);return{service:t,items:n}})}function Ze(e){return[...new Set(e.map(e=>e.serviceCategory))].sort().map(t=>{let n=e.filter(e=>e.serviceCategory===t),r=[...new Set(n.map(e=>e.service))].sort().map(e=>({service:e,items:n.filter(t=>t.service===e)}));return{category:t,services:r}})}function Qe(e,t,n=5){return e.filter(e=>e.toLowerCase().includes(t.toLowerCase())).reverse().slice(0,n)}function $e(e,t){let n=t.length,r=e.substring(0,n),i=e.substring(n);return{match:r,rest:i}}const et={GPT_3_5_TURBO:`gpt-3.5-turbo`,GPT_4O:`gpt-4o`,GPT_4O_MINI:`gpt-4o-mini`,GEMINI_PRO:`gemini-pro`,GEMINI_1_5:`gemini-1.5`,CLAUDE_3:`claude-3`,CLAUDE_INSTANT_100K:`claude-instant-100k`,AZURE_GPT_3_5_TURBO:`azure-gpt-3.5-turbo`,AZURE_GPT_4:`azure-gpt-4`,AZURE_GPT_4O:`azure-gpt-4o`},tt={OPENAI:`openai`,ANTHROPIC:`anthropic`,GOOGLE:`google`,AZURE:`azure`};var nt=`:host {
    position: fixed;
    bottom: 20px;
    right: 20px;
    z-index: 10000;
...
.toast-item.success .toast-progress {
    background: rgba(255, 255, 255, 0.4);
} `,rt={name:`agora-home`,private:!0,version:`1.0.0`,type:`module`,scripts:{dev:`vite`,build:`tsc && vite build`,preview:`vite preview`,"create-component":`node ./scripts/create.cjs`},devDependencies:{"plain-ts":`npm:plain-ts@latest`,typescript:`~5.9.3`,vite:`npm:rolldown-vite@7.1.14`},overrides:{vite:`npm:rolldown-vite@7.1.14`},dependencies:{marked:`^17.0.1`}};const T={APP_NAME:rt.name,VERSION:rt.version,API_HOST:`http://localhost:8010`,AI_HOST:`http://localhost:2020`,TRANSLATION_HOST:null,ENABLED_AI:!0,DEBUG_MODE:!1,IS_METAGORA:!0,MAX_HEIGHT:null};var it=class extends i{constructor(){super(`toast-container`,nt)}template(){return this.html`
...
`}</button>
                    ...
                    <div class="card-body">
                        <span class="icon globe-icon">${this.activeMode===`search`?ae:ie}</span>
                        <textarea 
        ...
        `,e.querySelectorAll(`.mention-item`).forEach((e,t)=>{e.onmousedown=e=>{e.preventDefault(),this.selectMention(this.mentionResults[t])},e.onmouseenter=()=>{this.activeMentionIndex=t,this.renderMentions()}}))}showMentions(){let e=this.$(`.mentions`),t=this.$(`.search-card`);e?.classList.remove(`hidden`),t?.classList.add(`has-mentions`)}hideMentions(){let e=this.$(`.mentions`),t=this.$(`.search-card`);e?.classList.add(`hidden`),t?.classList.remove(`has-mentions`),this.mentionResults=[],this.activeMentionIndex=-1}selectMention(e){let t=this.$(`textarea`);if(!t)return;let n=t.selectionStart||0,{newText:r,newCursorPosition:i}=this.mentionHandler.buildMentionText(t.value,this.mentionStartIndex,n,e.name);t.value=r,t.setSelectionRange(i,i),this.hideMentions(),this.isMentioning=!1,t.focus()}showSuggestions(){let e=this.$(`.suggestions`),t=this.$(`.search-card`);e?.classList.remove(`hidden`),t?.classList.add(`has-suggestions`)}hideSuggestions(){let e=this.$(`.suggestions`),t=this.$(`.search-card`);e?.classList.add(`hidden`),t?.classList.remove(`has-suggestions`)}renderSuggestions(e){let t=this.$(`.suggestions`);t&&(t.innerHTML=`
            <div class="suggestions-content">
                ${this.suggestions.map((t,n)=>{let{match:r,rest:i}=$e(t,e);return`
...
@media (max-width: 480px) {
    .ellipse {
...
}`,_t=class extends i{constructor(){super(`plain-intro-animation`,gt),setTimeout(()=>{let e=this.$(`.central-square`);e&&(e.style.opacity=`0`),setTimeout(()=>{this.style.opacity=`0`,setTimeout(()=>{this.remove()},1e3)},500)},3e3)}template(){return this.html`
            <div class="central-square">
                <section class="s_aupaeu_animated_background background-container" >
                    <div class="gradient-layer"></div>
                    <div class="ellipse ellipse-323"></div>
        ...
        `}};window.customElements.define(`plain-intro-animation`,_t);var vt=`.plain-detail-modal-wrapper {
    pointer-events: none;
    position: fixed;
    top: 0;
    left: 0;
...
@media (max-width: 900px) {
    ...
    .modal-title {
        ...
        `}listeners(){let e=this.$(`.modal-overlay`),t=this.$(`.close-btn`);e&&(e.onclick=t=>{t.target===e&&this.close()}),t&&(t.onclick=()=>this.close())}};window.customElements.define(`plain-detail-modal`,yt);var bt=`.plain-chat-window-wrapper {
    width: 100%;
    height: 100%;
...
}`;function j(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var M=j();function xt(e){M=e}var N={exec:()=>null};function P(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(F.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var St=(()=>{try{return!0}catch{return!1}})(),F={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`)},Ct=/^(?:[ \t]*(?:\n|$))+/,wt=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Tt=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,I=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Et=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,L=/(?:[*+-]|\d{1,9}[.)])/,Dt=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Ot=P(Dt).replace(/bull/g,L).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),kt=P(Dt).replace(/bull/g,L).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),R=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,At=/^[^\n]+/,jt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Mt=P(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,jt).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Nt=P(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,L).getRegex(),z=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,Pt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Ft=P(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,Pt).replace(`tag`,z).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),It=P(R).replace(`hr`,I).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,z).getRegex(),Lt={blockquote:P(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,It).getRegex(),code:wt,def:Mt,fences:Tt,heading:Et,hr:I,html:Ft,lheading:Ot,list:Nt,newline:Ct,paragraph:It,table:N,text:At},Rt=P(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,I).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,z).getRegex(),zt={...Lt,lheading:kt,table:Rt,paragraph:P(R).replace(`hr`,I).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,Rt).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,z).getRegex()},Bt={...Lt,html:P(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,Pt).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:N,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:P(R).replace(`hr`,I).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,Ot).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Vt=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ht=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Ut=/^( {2,}|\\)\n(?!\s*$)/,Wt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,B=/[\p{P}\p{S}]/u,Gt=/[\s\p{P}\p{S}]/u,Kt=/[^\s\p{P}\p{S}]/u,qt=P(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,Gt).getRegex(),Jt=/(?!~)[\p{P}\p{S}]/u,Yt=/(?!~)[\s\p{P}\p{S}]/u,Xt=/(?:[^\s\p{P}\p{S}]|~)/u,Zt=P(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,St?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),Qt=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,$t=P(Qt,`u`).replace(/punct/g,B).getRegex(),en=P(Qt,`u`).replace(/punct/g,Jt).getRegex(),tn=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,nn=P(tn,`gu`).replace(/notPunctSpace/g,Kt).replace(/punctSpace/g,Gt).replace(/punct/g,B).getRegex(),rn=P(tn,`gu`).replace(/notPunctSpace/g,Xt).replace(/punctSpace/g,Yt).replace(/punct/g,Jt).getRegex(),an=P(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,Kt).replace(/punctSpace/g,Gt).replace(/punct/g,B).getRegex(),on=P(/\\(punct)/,`gu`).replace(/punct/g,B).getRegex(),sn=P(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),cn=P(Pt).replace(`(?:-->|$)`,`-->`).getRegex(),ln=P(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,cn).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),V=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,un=P(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace(`label`,V).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),dn=P(/^!?\[(label)\]\[(ref)\]/).replace(`label`,V).replace(`ref`,jt).getRegex(),fn=P(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,jt).getRegex(),pn=P(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,dn).replace(`nolink`,fn).getRegex(),mn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,hn={_backpedal:N,anyPunctuation:on,autolink:sn,blockSkip:Zt,br:Ut,code:Ht,del:N,emStrongLDelim:$t,emStrongRDelimAst:nn,emStrongRDelimUnd:an,escape:Vt,link:un,nolink:fn,punctuation:qt,reflink:dn,reflinkSearch:pn,tag:ln,text:Wt,url:N},gn={...hn,link:P(/^!?\[(label)\]\((.*?)\)/).replace(`label`,V).getRegex(),reflink:P(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,V).getRegex()},_n={...hn,emStrongRDelimAst:rn,emStrongLDelim:en,url:P(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,mn).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:P(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,mn).getRegex()},vn={..._n,br:P(Ut).replace(`{2,}`,`*`).getRegex(),text:P(_n.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},H={normal:Lt,gfm:zt,pedantic:Bt},U={normal:hn,gfm:_n,breaks:vn,pedantic:gn},yn={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},bn=e=>yn[e];function W(e,t){if(t){if(F.escapeTest.test(e))return e.replace(F.escapeReplace,bn)}else if(F.escapeTestNoEncode.test(e))return e.replace(F.escapeReplaceNoEncode,bn);return e}function xn(e){try{e=encodeURI(e).replace(F.percentDecode,`%`)}catch{return null}return e}function Sn(e,t){let n=e.replace(F.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(F.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(F.slashPipe,`|`);return n}function G(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function Cn(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function wn(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function Tn(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
...
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=Tn(e,t[3]||``,this.rules);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let t=G(e,`#`);(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:`heading`,raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:G(t[0],`
