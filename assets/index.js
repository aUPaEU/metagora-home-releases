...
@keyframes skeleton-shimmer {
    ...
    100% {
...
}`;const m={COMPANY:`company`,CONFIG:`config`,RESULT:`result`,SERVICE:`service`,METAGORA:`metagora`,SEARCH:`search`,FILTER:`filter`,MODAL:`modal`,CHAT:`chat`};var ne=class extends i{companyContext;constructor(){super(`plain-logo`,te),this.companyContext=this.useContext(m.COMPANY,!0)}renderSkeletonLoader(){return this.html`
        ...
        `:this.renderSkeletonLoader()}};window.customElements.define(`plain-logo`,ne);var re=`.plain-nav-menu-wrapper {
    width: 100%;
    height: fit-content;
}
...
`};var ge=class extends i{companyContext;constructor(){super(`plain-nav-item`,ie),this.companyContext=this.useContext(`company`)}showTooltip(e){let t=e.currentTarget,n=t.querySelector(`.tooltip`);if(!n)return;let r=t.getBoundingClientRect();n.style.position=`fixed`,n.style.top=`${r.top-n.offsetHeight-8}px`,n.style.left=`${r.left+r.width/2-n.offsetWidth/2}px`,n.style.visibility=`visible`,n.style.opacity=`1`}hideTooltip(e){let t=e.currentTarget.querySelector(`.tooltip`);t&&(t.style.visibility=`hidden`,t.style.opacity=`0`)}template(){let e=this.props.mainUrl?this.html`
                ...
                >
                    ${!this.props.companyName&&this.props.serviceIcon&&y[this.props.serviceIcon]?this.html`<span class="item-icon">${y[this.props.serviceIcon]}</span>`:``}
                    ${this.props.serviceName}
                    ${this.props.mainUrl?this.html`<span class="nav-arrow">${v}</span>`:``}
            ...
            <div class="plain-nav-item-wrapper ">
                ...
                >
                    ${this.props.companyName?this.html`
                        ...
                        `:!this.props.mainUrl&&this.props.serviceIcon&&y[this.props.serviceIcon]?this.html`
                                <span class="item-icon">${y[this.props.serviceIcon]}</span>
                            `:``}
        ...
        `}};window.customElements.define(`plain-nav-item`,ge);var _e=`.plain-catalogue-item-wrapper {
    display: block;
}
...
.label.disabled {
    color: #a8a8a8;
}`,ve=class extends i{configContext;metagoraContext;constructor(){super(`plain-catalogue-item`,_e),this.configContext=this.useContext(m.CONFIG,!0),this.metagoraContext=this.useContext(m.METAGORA,!0)}template(){let e=this.configContext.get(`IS_METAGORA`),t=e?(this.metagoraContext.get(`agoras`)||[]).find(e=>e.name===this.props.companyName):void 0,n=`${this.props.website||(e?t?.host:this.configContext.get(`API_HOST`))}${this.props.url}`;return e&&!t?this.html`
...
`}</span>
        ...
        `}};window.customElements.define(`plain-catalogue-item`,ve);function b(e){return!e||Array.isArray(e)?[]:e.websites??[]}var ye=class extends i{serviceContext;companyContext;searchQuery=``;searchTimeout=null;constructor(){super(`plain-nav-menu`,re),this.serviceContext=this.useContext(m.SERVICE,!0),this.companyContext=this.useContext(m.COMPANY,!0)}handleSearch(e){let t=e.target.value.toLowerCase();this.searchTimeout&&clearTimeout(this.searchTimeout),this.searchTimeout=window.setTimeout(()=>{this.searchQuery=t,this.updateList()},300)}updateList(){let e=this.$(`#services-list`);e&&(e.innerHTML=this.getServicesListHTML())}renderSkeletonLoader(){let e=[,,,,].fill(null).map((e,t)=>this.html`
        ...
        `}getServicesListHTML(){let e=this.serviceContext.get(`services`),t=this.searchQuery;if(!e||e.length===0)return``;let n=e.filter(e=>{if(!t)return!0;let n=e.fields.name?.toLowerCase()||``,r=b(e.fields.catalogues).some(e=>e.name?.toLowerCase().includes(t));return n.includes(t)||r});return n.length===0?this.html`
                <div class="no-results">
                    No services found matching your search
                </div>
            `:this.html`
            ${n.map((e,t)=>{let r=b(e.fields.catalogues),i=r&&r.length>0,a=e.fields.main_url&&e.fields.main_url!==`False`?e.fields.main_url:``,o=this.html`
                    <plain-nav-item
                ...
                `;return i?this.html`
                    ...
                    ${t===n.length-1?``:`<hr class="nav-item-separator"/>`}
                `:this.html`
                    <summary>
                        ${o}
                    </summary>
...
@keyframes loading {
    ...
    100% {
        ...
        `}};window.customElements.define(`plain-metagora-nav-menu`,we);var Te=`.plain-greetings-wrapper {
    box-sizing: border-box;
...
@media (max-width: 768px) {
    ...
    .prompt {
        ...
        `}};window.customElements.define(`plain-greetings`,Ee);var De=`.plain-carousel-wrapper {
    height: 100%;
...
@media (max-height: 350px) {
    ...
    .tag {
            ...
            <div class="carousel-container ${this.props.variant?`carousel-${this.props.variant}`:``}">
                <div class="slide">
                    ...
                    <div class="content">
                        ...
                        ${this.props.variant!==`small`&&this.html`<p class="description anim-slide-text">${r}</p>`}
        ...
        `}listeners(){let e=this.$$(`.dot`);e&&e.forEach((e,t)=>{e.onclick=()=>this.setSlide(t)})}};window.customElements.define(`plain-carousel`,Oe);var ke=`.plain-metagora-hero-wrapper {
    width: 100%;
    height: 100%;
    position: relative;
...
}`,Ae=class extends i{metagoraContext;words=[`Explore`,`Transform`,`Empower`,`Accelerate`,`Bound`,`Innovate`];currentWordIndex=0;intervalId=null;wordElement=null;constructor(){super(`plain-metagora-hero`,ke),this.metagoraContext=this.useContext(m.METAGORA,!0)}template(){let e=this.metagoraContext.get(`agoras`)||[];return this.html`
            ...
            <section class="metagora-hero--content">
                <div class="metagora-hero--left">
                    ...
                    <div class="metagora-hero--cta-container">
                        ...
                        >
                            Know more about us
                            <span class="metagora-hero--cta-icon">${v}</span>
                        </a>
...
}`;function Ne(e,t){return e?e.startsWith(`http://`)||e.startsWith(`https://`)?e:`${t}${e}`:``}function Pe(e,t,n,r,i){if(!e||!t)return i||`#`;let a=n.filter(e=>e._sourceHost===r);for(let n of a){let i=b(n.fields?.catalogues);for(let n of i)if(n.model===e)return`${r}/offering/${n.view_id}/${t}`}for(let i of n){let n=b(i.fields?.catalogues);for(let i of n)if(i.model===e)return`${r}/offering/${i.view_id}/${t}`}return i||`#`}function Fe(e,t=1){let n=e.startsWith(`#`)?e.slice(1):e,r=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),a=parseInt(n.slice(4,6),16);return`rgba(${r}, ${i}, ${a}, ${t})`}function Ie(e,t,n){if(!e||!t||t.length===0)return e;let r=e;return[...t].sort((e,t)=>t.length-e.length).forEach(e=>{if(!e)return;let t=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),i=RegExp(`\\b(${t}\\w*)`,`gi`),a=n.startsWith(`#`)?Fe(n,.2):`${n}33`;r=r.replace(i,`<mark style="background-color: ${a};">$1</mark>`)}),r}var Le=`.score-badge {
    display: flex;
    align-items: center;
    gap: 0.375rem;
    background-color: #f3f4f6;
...
`,Re=class extends i{constructor(){super(`plain-score-badge`,Le)}get score(){let e=this.props.score;if(e==null||e===`null`||e===``)return null;let t=parseFloat(e);return isNaN(t)?null:t}get aiPickTitle(){return this.props.aiPickTitle||`Suggested by AI assistant`}get matchTitle(){return this.props.matchTitle||`This is the relevance of the result`}template(){let e=this.score;return e===null?this.html`
            ...
            <div class="card full-card">
                ${e.image_url?this.html`
                        <div class="card-image-container">
                            <div 
                                class="card-image" 
                                style="background-image: url('${Ne(e.image_url,t)}')"
                            ></div>
                        </div>
                    `:``}
...
`;const C={RESULTS_FETCHED:`results-fetched`,RESULTS_CLEARED:`results-cleared`,CHAT_STARTED:`chat-started`,CHAT_USER_MESSAGE:`chat-user-message`,CHAT_MESSAGE_CHUNK:`chat-message-chunk`,CHAT_MESSAGE_COMPLETE:`chat-message-complete`,CHAT_RESULTS_UPDATED:`chat-results-updated`,CHAT_FETCHING_RESULTS:`chat-fetching-results`,NEW_CHAT:`new-chat`,MODE_SWITCH:`mode-switch`};function Ye(e){return e.length&&Math.max(...e.map(e=>e.score))||1}function Xe(e,t){let n=e.filter(e=>e.service===t);return n.length&&Math.max(...n.map(e=>e.score))||1}function Ze(e,t,n=.1){return e.filter(e=>e.score[t]>=n)}function Qe(e,t){e.forEach(e=>{let n=t.find(t=>t.models.includes(e.model));n?(e.service=n.service,e.serviceCategory=n.category):(console.warn(`No service found for model: ${e.model}`),e.service=`unknown`,e.serviceCategory=`Other`)})}function $e(e,t,n){let r=Ye(e);return e.sort((e,t)=>t.score-e.score).map(i=>{let a=t.find(e=>e.model===i.model),o=a?.name||i.model,s=a?.website,c=a?.url,l=i._sourceHost||n,u=s?`${s}${c}`:`${l}${c}`,d=Xe(e,i.service);return{model:i.model,model_verbose_name:o,model_view_url:u,service:i.service,serviceCategory:i.serviceCategory||`Other`,featured_fields:i.featured_fields||[`web_link`,`url`,`website`],featured:i.featured||!1,data:i.data,roots:i.roots,score:{absolute:Number((i.score/r).toFixed(2)),relative:Number((i.score/d).toFixed(2))},_sourceHost:i._sourceHost}})}function et(e){return[...new Set(e.map(e=>e.service))].sort().map(t=>{let n=e.filter(e=>e.service===t);return{service:t,items:n}})}function tt(e){return[...new Set(e.map(e=>e.serviceCategory))].sort().map(t=>{let n=e.filter(e=>e.serviceCategory===t),r=[...new Set(n.map(e=>e.service))].sort().map(e=>({service:e,items:n.filter(t=>t.service===e)}));return{category:t,services:r}})}function nt(e,t,n=5){return e.filter(e=>e.toLowerCase().includes(t.toLowerCase())).reverse().slice(0,n)}function rt(e,t){let n=t.length,r=e.substring(0,n),i=e.substring(n);return{match:r,rest:i}}const it={GPT_3_5_TURBO:`gpt-3.5-turbo`,GPT_4O:`gpt-4o`,GPT_4O_MINI:`gpt-4o-mini`,GEMINI_PRO:`gemini-pro`,GEMINI_1_5:`gemini-1.5`,CLAUDE_3:`claude-3`,CLAUDE_INSTANT_100K:`claude-instant-100k`,AZURE_GPT_3_5_TURBO:`azure-gpt-3.5-turbo`,AZURE_GPT_4:`azure-gpt-4`,AZURE_GPT_4O:`azure-gpt-4o`},at={OPENAI:`openai`,ANTHROPIC:`anthropic`,GOOGLE:`google`,AZURE:`azure`};var ot=`:host {
    position: fixed;
    bottom: 20px;
    right: 20px;
    z-index: 10000;
...
.toast-item.success .toast-progress {
    background: rgba(255, 255, 255, 0.4);
} `,st={name:`agora-home`,private:!0,version:`1.0.0`,type:`module`,scripts:{dev:`vite`,build:`tsc && vite build`,preview:`vite preview`,"create-component":`node ./scripts/create.cjs`},devDependencies:{"plain-ts":`npm:plain-ts@latest`,typescript:`~5.9.3`,vite:`npm:rolldown-vite@7.1.14`},overrides:{vite:`npm:rolldown-vite@7.1.14`},dependencies:{marked:`^17.0.1`}};const w={APP_NAME:st.name,VERSION:st.version,API_HOST:`http://localhost:8010`,AI_HOST:`http://localhost:2020`,TRANSLATION_HOST:null,ENABLED_AI:!0,DEBUG_MODE:!1,IS_METAGORA:!0,MAX_HEIGHT:null,VISIBLE_LOGO:!0};var ct=class extends i{constructor(){super(`toast-container`,ot)}template(){return this.html`
        ...
        `,t.appendChild(n);let a=n.querySelector(`.toast-close`);a&&a.addEventListener(`click`,()=>this.removeToast(n)),setTimeout(()=>{this.removeToast(n)},i)}removeToast(e){if(!e.parentElement)return;e.classList.remove(`fade-in`),e.classList.add(`fade-out`);let t=n=>{n.animationName===`slideOut`&&(e.removeEventListener(`animationend`,t),e.remove())};e.addEventListener(`animationend`,t)}getIcon(e){return{error:`✕`,warning:`⚠`,info:`ℹ`,success:`✓`}[e]}};function lt(e,t=`info`,n=5e3){if(!w.DEBUG_MODE)return;let r=document.querySelector(`agora-app`)?.shadowRoot?.querySelector(`toast-container`);r&&r.addToast({message:e,type:t,duration:n})}function T(e,t){if(!w.DEBUG_MODE)return;let n=e instanceof Error?e.message:e,r=t?`[${t}] ${n}`:n;lt(r,`error`,8e3)}window.customElements.define(`toast-container`,ct);var E={GET_AGORA_SERVICES:`/catalogue-api/v2/acceleration-services/1`,GET_AGORA_SEARCH_RESULTS:`/elastic/search`,GET_AGORA_INGEST_MODEL:`/elastic/ingest`,SEND_MESSAGE:`/assistant/rag/stream`,FETCH_ELEMENT:`/catalogue-api/v2`,GET_AIDA_API_KEY:`/catalogue-api/v2/api-key/aida`};const D={GET_ALL_AGORA_URLS:async()=>[`https://agora.unite-university.eu/`,`https://eugreen.pre.widening.eu/`,`https://eudres.widening.eu/`,`https://civis.widening.eu/`,`https://aupaeu.widening.eu/`,`https://forthem.widening.eu/`,`https://eutopia-agora.widening.eu/`,`https://circle-u.widening.eu/`,`https://heroes.widening.eu/`,`https://uninovis.widening.eu/`,`https://foreu4all.widening.eu/`],GET_AGORA_SERVICES:async e=>{try{let t=`${e}${E.GET_AGORA_SERVICES}`,n=await fetch(t);if(!n.ok)throw T(Error(`Failed to fetch Agora services from ${t}`),`GET_AGORA_SERVICES`),Error(`Something went wrong while fetching the Agora services`);return await n.json()}catch(e){throw T(e,`GET_AGORA_SERVICES`),e}},GET_AGORA_SEARCH_RESULTS:async(e,t,n,r,i)=>{if(!t||t.length===0)throw Error(`No query provided`);if(n.length===0)throw Error(`No models provided for the search`);let a=`${e}${E.GET_AGORA_SEARCH_RESULTS}?query=${t}&models=${n.join()}`;try{let e=await fetch(a);if(!e.ok&&e.status===404){let t=await e.json();throw Error(JSON.stringify(t))}return await e.json()}catch(e){throw T(e,`GET_AGORA_SEARCH_RESULTS`),e}},GET_AGORA_INGEST_MODEL:async(e,t)=>{let n=`${e}${E.GET_AGORA_INGEST_MODEL}/${t}`;try{let e=await fetch(n);if(!e.ok){let t=await e.json();throw Error(t.message)}return await e.json()}catch(e){throw T(e,`GET_AGORA_INGEST_MODEL`),e}},SEND_MESSAGE:async(e,t,n=[],r=``,i=it.GPT_4O_MINI,a=at.OPENAI,o=.7)=>{let s={message:t,history:n,context:r,model:i,provider:a,temperature:o},c=`${e}${E.SEND_MESSAGE}`;try{let e=await fetch(c,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(s)});if(!e.ok)throw Error(`Something went wrong while sending message`);return e.body instanceof ReadableStream?e:await e.json()}catch(e){throw T(e,`SEND_MESSAGE`),e}},FETCH_ELEMENT:async(e,t,n)=>{let r=`${e}${E.FETCH_ELEMENT}/${t}/${n}`;try{let e=localStorage.getItem(`aida_ak`);if(!e)throw Error(`AIDA API key not found. Please ensure you are properly authenticated.`);let i=await fetch(r,{method:`GET`,headers:{accept:`application/json`,Authorization:`Bearer ${e}`}});if(!i.ok){if(i.status===404){let e=await i.json();throw Error(JSON.stringify(e))}if(i.status===401||i.status===403){let e=await i.json();throw Error(JSON.stringify(e))}throw Error(`Failed to fetch element ${t}/${n}`)}return await i.json()}catch(e){throw T(e,`FETCH_ELEMENT`),e}},GET_AIDA_API_KEY:async(e,t=[])=>{try{let n=new URLSearchParams;t&&t.length>0&&n.append(`models`,t.join(`,`));let r=`${e}${E.GET_AIDA_API_KEY}${n.toString()?`?${n.toString()}`:``}`,i=await fetch(r,{method:`GET`,headers:{accept:`application/json`}});if(!i.ok){if(i.status===400){let e=await i.json();throw Error(e.error?.message||`Bad request when fetching API key`)}if(i.status===500){let e=await i.json();throw Error(e.error?.message||`Server error when fetching API key`)}throw Error(`Something went wrong while fetching AIDA API key`)}return await i.json()}catch(e){throw T(e,`GET_AIDA_API_KEY`),e}},GET_MULTIPLE_AIDA_API_KEYS:async(e,t={})=>{let n={};return await Promise.all(e.map(async e=>{try{let r=await D.GET_AIDA_API_KEY(e,t[e]);r?.token?.jwt_token&&(n[e]=r.token.jwt_token)}catch(t){console.warn(`Failed to fetch API key for host: ${e}`,t)}})),n}},O=(e,t)=>{let n=[];function r(e){for(let i in e)Object.prototype.hasOwnProperty.call(e,i)&&(i===t&&n.push({[t]:e[i]}),typeof e[i]==`object`&&e[i]!==null&&r(e[i]))}return r(e),n};var ut=class{deps;callbacks;messageBuffer=``;isFirstChunk=!0;shouldResetResults=!1;constructor(e,t){this.deps=e,this.callbacks=t}async chat(e){if(!e){console.warn(`No message provided`);return}this.callbacks.showSpinner(),this.isFirstChunk=!0,this.messageBuffer=``,this.deps.signals.emit(C.CHAT_STARTED),this.storeMessageInChatContext(e,`user`),this.deps.signals.emit(C.CHAT_USER_MESSAGE);try{let t=this.deps.configContext.get(`AI_HOST`),n=this.formatMessageHistory(),r=this.extractMentionsFromMessage(e),i=this.filterResultsByMentions(r),a=this.buildChatContext(i),o=await D.SEND_MESSAGE(t,e,n,a);if(o.body instanceof ReadableStream)await this.handleStreamingResponse(o);else{let e=o,t=e.response||e.message||``;this.storeMessageInChatContext(t,`ai`),this.deps.signals.emit(C.CHAT_MESSAGE_COMPLETE,t)}}catch(e){console.error(`Chat error:`,e)}finally{this.callbacks.hideSpinner(),this.shouldResetResults=!0}}buildChatContext(e){let t=this.deps.companyContext.get(`name`)||`the alliance`,n=this.deps.resultContext.get(`data`)?.length||0,r=e.map(e=>` >> Resource: ${JSON.stringify(e)}\n`),i=[`You are a helpful assistant working in the Metagora platform.`,`Metagora is a HUB that grants access to all university resources and services within all the university alliances that are using the Agora platform.`,`Agora is a platform to manage and share university resources within a university alliance.`,`An Agora is a service that serves as a central hub that provides access to services and resources offered by the alliance members.`,`A university alliance is a collaboration between multiple universities to share resources, knowledge, and services for the benefit of their students and staff.`,`This site is the Metagora.`].join(`
`)+`
...
`,s,o].join(`
`)}formatMessageHistory(){return(this.deps.chatContext.get(`history`)||[]).map(e=>({role:e.author===`user`?`user`:`ai`,content:e.content}))}storeMessageInChatContext(e,t){if(!e||e.trim()===``)return;let n=this.deps.chatContext.get(`history`)||[];n.push({content:e,author:t,time:new Date().toLocaleTimeString()}),this.deps.chatContext.set({history:n}),this.callbacks.updateClearButtonVisibility()}async handleStreamingResponse(e){let t=e.body.getReader(),n=new TextDecoder;try{for(;;){let{done:e,value:r}=await t.read();if(e)break;let i=n.decode(r,{stream:!0});this.handleChunk(i)}this.messageBuffer&&=(this.storeMessageInChatContext(this.messageBuffer,`ai`),this.deps.signals.emit(C.CHAT_MESSAGE_COMPLETE,this.messageBuffer),``)}catch(e){throw console.error(`Stream reading error:`,e),e}}splitChunkByTags(e){let t=/(\[\$\w+\])(.*?)(?=\[\$\w+\]|$)/gs,n=[],r;for(;(r=t.exec(e))!==null;){let e=r[1],t=r[2];if(e===`[$done]`){n.length>0&&(n[n.length-1].content+=` [$done]`);continue}n.push({tag:e,content:t})}return n}handleChunk(e){this.splitChunkByTags(e).forEach(e=>{if(e.tag===`[$artifact]`)try{let t=JSON.parse(e.content.replace(/'/g,`"`));this.handleChatResults(t)}catch(e){console.error(`Error parsing artifact:`,e)}else if(e.tag===`[$message]`){let t=e.content.includes(`[$done]`),n=t?e.content.split(`[$done]`)[0]:e.content;this.handleChatMessage({isFirstChunk:this.isFirstChunk,isLastChunk:t,message:n}),this.isFirstChunk&&=!1}})}handleChatMessage(e){if(e.isFirstChunk&&this.callbacks.hideSpinner(),e.isLastChunk){let t=this.messageBuffer+e.message;this.storeMessageInChatContext(t,`ai`),this.deps.signals.emit(C.CHAT_MESSAGE_COMPLETE,t),this.messageBuffer=``;return}this.messageBuffer+=e.message,e.message&&this.deps.signals.emit(C.CHAT_MESSAGE_CHUNK,{chunk:e.message,fullMessage:this.messageBuffer})}async handleChatResults(e){if(!e||e.length===0)return;let t={grouped:[],data:[]};this.shouldResetResults||(t.data=this.deps.resultContext.get(`data`)||[],t.grouped=this.deps.resultContext.get(`grouped`)||[]),this.shouldResetResults&&=!1;let n=this.deps.serviceContext.get(`services`)||[],r=O(n,`websites`).flatMap(e=>e.websites),i={},a=e=>{t.data.push(e),t.grouped=[...new Set(t.data.map(e=>e.service))].sort().map(e=>({service:e,items:t.data.filter(t=>t.service===e)})),this.deps.resultContext.set(t,!0),this.deps.signals.emit(C.CHAT_RESULTS_UPDATED,t.grouped),this.deps.signals.emit(C.RESULTS_FETCHED,t.data)};this.deps.signals.emit(C.CHAT_FETCHING_RESULTS,!0),(async()=>{for(let t of e){i[t.model]=r.find(e=>e.model===t.model)?.name||null;let e=t.model,o=null;if(n.forEach(t=>{let n=t.fields?.catalogues?.websites;if(!n)return;let r={};n.forEach(t=>{if(!t.model||t.model!==e)return;let n={model:t.model,model_verbose_name:t.model_verbose_name,model_website:t.website,model_view_url:t.url,model_view_id:t.view_id};r[t.model]=n}),e in r&&(o={service:t.fields.name,serviceCategory:S(t.fields.category),models:r})}),!o)continue;let s=o,c;try{c=await D.FETCH_ELEMENT(this.deps.configContext.get(`API_HOST`),t.model,Number(t.source_id))}catch(e){console.error(`Error fetching element:`,e);continue}if(!c)continue;Object.entries(c.fields).forEach(([e,t])=>{if(typeof t==`string`&&(t.startsWith(`[`)||t.startsWith(`{`)))try{let n=xe(t);n&&(c.fields[e]=n.name||t)}catch(n){console.warn(`Could not parse field ${e} with value ${t} as JSON:`,n)}});let l=c.fields?.x_image||null;l&&=l.replace(this.deps.configContext.get(`API_HOST`),``);let u=c.fields?.detail_url?s.models[e].model_website+s.models[e].model_view_url:null,d={data:{...c.fields,id:c.id,image:l},featured:c.fields?.featured||!1,featured_fields:[`web_link`,`url`,`website`],model:t.model,model_verbose_name:i[t.model],model_view_url:u,roots:[],score:{absolute:null,relative:null},service:s.service,serviceCategory:s.serviceCategory};a(d)}this.deps.signals.emit(C.CHAT_FETCHING_RESULTS,!1)})()}extractMentionsFromMessage(e){let t=/@([^@\n]+?)(?=\s*@|\s*$)/g,n=[],r;for(;(r=t.exec(e))!==null;){let e=r[1].trim();e&&n.push(e.toLowerCase())}return n}filterResultsByMentions(e){return e.length===0?[]:(this.deps.resultContext.get(`data`)||[]).filter(t=>{let n=this.getResultDisplayName(t).toLowerCase();return e.some(e=>n.includes(e)||e.includes(n))})}getResultDisplayName(e){let t=e.data||{};for(let e of[`name`,`title`,`Name`,`Title`,`headline`,`label`,`display_name`])if(t[e]&&typeof t[e]==`string`)return t[e];return e.model_verbose_name||``}clearChatHistory(){this.deps.chatContext.set({history:[]}),this.messageBuffer=``}newChat(e){this.deps.chatContext.set({history:[]}),this.messageBuffer=``,e(),this.deps.signals.emit(C.NEW_CHAT)}};const dt=async(e,t,n)=>{if(!t||t.trim()===``)return console.warn(`No query provided`),{data:null};if(n.length===0)return console.warn(`No models provided`),{data:null};let r=t.replace(/[^^A-Za-z0-9 ]/g,``),i={raw:r,translated:r};try{return{data:await D.GET_AGORA_SEARCH_RESULTS(e,i.translated,n)}}catch(e){throw console.log(`Error during query:`,JSON.parse(e.message)),T(e,`Search Query`),e}},ft=async(e,t)=>{try{return lt(`Elasticsearch is ingesting the missing model data.\n
            Ingesting missing data from the model: '${t}' into Elasticsearch`,`warning`,1e4),console.warn(`ELASTICSEARCH IS INGESTING\nIngesting missing data from the model: '${t}' into Elasticsearch`),await D.GET_AGORA_INGEST_MODEL(e,t),null}catch(e){return T(e,`Model Data Ingestion`),e}};var pt=class{props;callbacks;constructor(e,t){this.props=e,this.callbacks=t}async search(e){let t=this.props.serviceContext.get(`models`);if(!e||e.trim()===``){console.warn(`No query provided`);return}if(t.length===0){console.warn(`No models provided`);return}this.callbacks.hideSuggestions(),this.callbacks.showSpinner();let n=this.sanitizeQuery(e);if(this.props.configContext.get(`IS_METAGORA`)){let t=this.props.serviceContext.get(`modelsByAgora`)||{},r=new Map;await Promise.all(Object.entries(t).map(async([e,t])=>{if(t.length===0){console.warn(`No models available for Agora at host ${e}`);return}try{let i=(await dt(e,n,t)).data.results;r.set(e,i)}catch(t){console.error(`Error querying Agora at host ${e}\n${t}`),r.set(e,[])}})),this.callbacks.hideSpinner(),this.handleMetagoraSearchResults(e,r);return}try{let r=await dt(this.props.configContext.get(`API_HOST`),n,t);this.callbacks.hideSpinner();let i=r.data.results;this.handleSearchResults(e,i)}catch(t){try{let n=JSON.parse(t.message);if(n.missing_model){let t=await ft(this.props.configContext.get(`API_HOST`),n.missing_model);if(t){console.error(`ELASTICSEARCH INGESTION ERROR\n${t}`),this.callbacks.hideSpinner();return}await this.search(e)}}catch{throw console.error(`SEARCH ERROR\n${t}`),this.callbacks.hideSpinner(),t}}}sanitizeQuery(e){return e.replace(/[^^A-Za-z0-9 ]/g,``)}handleSearchResults(e,t,n=!1){if(this.props.signals.emit(C.RESULTS_FETCHED,t),this.callbacks.updateClearButtonVisibility(t.length>0),t.length===0){this.props.resultContext.set({data:[],grouped:[]},!0);return}this.storeQueryInContext({raw:e,translated:e});let r=this.props.serviceContext.get(`services`),i=[...new Set(r.map(e=>({service:e.fields.name,category:S(e.fields.category),models:O(e,`model`).map(e=>e.model)})))];Qe(t,i);let a=O(r,`websites`).flatMap(e=>e.websites),o=$e(t,a,this.props.configContext.get(`API_HOST`)),s=Ze(o,`absolute`),c=et(s);this.props.resultContext.set({data:s,grouped:c},!0)}handleMetagoraSearchResults(e,t){let n=[];if(t.forEach((e,t)=>{let r=e.map(e=>({...e,_sourceHost:t}));n.push(...r)}),this.props.signals.emit(C.RESULTS_FETCHED,n),this.callbacks.updateClearButtonVisibility(n.length>0),n.length===0){this.props.resultContext.set({data:[],grouped:[]},!0);return}this.storeQueryInContext({raw:e,translated:e});let r=this.props.serviceContext.get(`services`),i=[...new Set(r.map(e=>({service:e.fields.name,category:S(e.fields.category),models:O(e,`model`).map(e=>e.model)})))];Qe(n,i);let a=O(r,`websites`).flatMap(e=>e.websites),o=$e(n,a,``),s=Ze(o,`absolute`),c=tt(s),l=c.flatMap(e=>e.services);this.props.resultContext.set({data:s,grouped:l,groupedByCategory:c},!0)}storeQueryInContext(e){let t=this.props.searchContext.get(`history`)||[],n={history:[...new Set([...t,e.raw])],current:e.translated.split(` `)};this.props.searchContext.set(n)}},mt=class{deps;constructor(e){this.deps=e}checkForMention(e,t){let n=-1;for(let r=t-1;r>=0;r--){let t=e[r];if(t===` `||t===`
...
}`,gt=class extends i{constructor(){super(`plain-spinner`,ht)}template(){return this.html`
            <div class="spinner"></div>
        `}};window.customElements.define(`plain-spinner`,gt);var _t=class extends i{activeMode=`search`;inputValues={search:``,chat:``};suggestions=[];activeSuggestionIndex=-1;mentionResults=[];activeMentionIndex=-1;mentionStartIndex=-1;isMentioning=!1;companyContext;configContext;serviceContext;searchContext;resultContext;filterContext;chatContext;chatHandler;searchHandler;mentionHandler;constructor(){super(`plain-agora-input`,[Ve,He,Ue,We,Ge,Ke,qe,Je].join(`
`)),this.companyContext=this.useContext(m.COMPANY),this.configContext=this.useContext(m.CONFIG),this.serviceContext=this.useContext(m.SERVICE),this.searchContext=this.useContext(m.SEARCH,!1,`local`),this.resultContext=this.useContext(m.RESULT),this.filterContext=this.useContext(m.FILTER),this.chatContext=this.useContext(m.CHAT),this.signals=this.useSignals(),this.signals.register(C.RESULTS_FETCHED),this.signals.register(C.RESULTS_CLEARED),this.signals.register(C.CHAT_STARTED),this.signals.register(C.CHAT_USER_MESSAGE),this.signals.register(C.CHAT_MESSAGE_CHUNK),this.signals.register(C.CHAT_MESSAGE_COMPLETE),this.signals.register(C.CHAT_RESULTS_UPDATED),this.signals.register(C.CHAT_FETCHING_RESULTS),this.signals.register(C.NEW_CHAT),this.signals.register(C.MODE_SWITCH),this.initializeHandlers()}initializeHandlers(){this.chatHandler=new ut({configContext:this.configContext,serviceContext:this.serviceContext,companyContext:this.companyContext,resultContext:this.resultContext,filterContext:this.filterContext,chatContext:this.chatContext,signals:this.signals},{showSpinner:()=>this.showSpinner(),hideSpinner:()=>this.hideSpinner(),updateClearButtonVisibility:()=>this.updateClearButtonVisibility()}),this.searchHandler=new pt({configContext:this.configContext,serviceContext:this.serviceContext,resultContext:this.resultContext,searchContext:this.searchContext,signals:this.signals},{showSpinner:()=>this.showSpinner(),hideSpinner:()=>this.hideSpinner(),hideSuggestions:()=>this.hideSuggestions(),updateClearButtonVisibility:e=>{let t=this.$(`.clear-btn-header`);e?t?.classList.remove(`hidden`):t?.classList.add(`hidden`)}}),this.mentionHandler=new mt({resultContext:this.resultContext})}toggleMode(e,t){t.stopPropagation();let n=this.$(`textarea`);n&&(this.inputValues[this.activeMode]=n.value),this.activeMode=e,this.suggestions=[],this.activeSuggestionIndex=-1,this.hideSuggestions(),this.mentionResults=[],this.activeMentionIndex=-1,this.isMentioning=!1,this.hideMentions(),this.updateTabs(),this.updateInputState(),this.updateIcon(),n&&(n.value=this.inputValues[e]),this.signals.emit(C.MODE_SWITCH,e)}updateTabs(){let e=this.$(`.tabs`),t=this.$(`.search-card`),n=this.$(`.trending`);this.activeMode===`search`?(e?.classList.remove(`mode-chat`),e?.classList.add(`mode-search`),t?.classList.remove(`mode-chat`),n?.classList.remove(`hidden`)):(e?.classList.remove(`mode-search`),e?.classList.add(`mode-chat`),t?.classList.add(`mode-chat`),n?.classList.add(`hidden`))}updateInputState(){let e=this.$(`textarea`);e&&(e.classList.add(`placeholder-hidden`),setTimeout(()=>{this.activeMode===`search`?(e.setAttribute(`maxlength`,`100`),e.setAttribute(`placeholder`,`Search for funding, courses, infrastructure...`)):(e.removeAttribute(`maxlength`),e.setAttribute(`placeholder`,`Ask the AI assistant...`)),e.classList.remove(`placeholder-hidden`)},200))}updateIcon(){let e=this.$(`.globe-icon`);e&&(e.innerHTML=this.activeMode===`search`?ae:h)}template(){let e=this.companyContext.get(`primaryColor`)||`#8238eb`,t=this.configContext.get(`ENABLED_AI`)?this.html`
...
`}</button>
                    ...
                    <div class="card-body">
                        <span class="icon globe-icon">${this.activeMode===`search`?ae:h}</span>
                        <textarea 
        ...
        `}afterRender(){this.updateClearButtonVisibility()}listeners(){let e=this.$(`.tab[data-mode="search"]`),t=this.$(`.tab[data-mode="chat"]`),n=this.$(`.go-btn`),r=this.$(`.clear-btn-header`),i=this.$(`.new-chat-btn`),a=this.$(`textarea`);e&&(e.onclick=e=>this.toggleMode(`search`,e)),t&&(t.onclick=e=>this.toggleMode(`chat`,e)),n&&(n.onclick=()=>this.handleSubmit()),r&&(r.onclick=()=>this.clear()),i&&(i.onclick=()=>this.newChat()),a&&(a.onkeydown=e=>this.handleKeyDown(e)),a&&(a.oninput=e=>this.handleInput(e))}handleSubmit(){let e=this.$(`textarea`),t=e?.value?.trim()||``;this.activeMode===`search`?this.searchHandler.search(t):(e.value=``,this.chatHandler.chat(t))}showSpinner(){let e=this.$(`.go-btn`),t=this.$(`textarea`);e&&(e.querySelector(`plain-spinner`)||(e.dataset.originalHtml=e.innerHTML,e.innerHTML=`<plain-spinner></plain-spinner>`,e.disabled=!0,e.style.cursor=`not-allowed`,t&&(t.disabled=!0,t.style.cursor=`not-allowed`,t.style.opacity=`0.6`)))}hideSpinner(){let e=this.$(`.go-btn`),t=this.$(`textarea`);e&&(e.innerHTML=e.dataset.originalHtml||he,e.disabled=!1,e.style.cursor=`pointer`,t&&(t.disabled=!1,t.style.cursor=`text`,t.style.opacity=`1`,t.focus()))}clear(){let e=this.$(`textarea`);e&&(e.value=``,e.focus()),this.hideSuggestions(),this.$(`.clear-btn-header`)?.classList.add(`hidden`),this.resultContext.set({data:[],grouped:[]},!0),this.signals.emit(C.RESULTS_CLEARED);let t=this.searchContext.get(`history`)||[];this.searchContext.set({history:t,current:[]}),this.filterContext.set([],`filters`,!0)}updateClearButtonVisibility(){let e=this.$(`.clear-btn-header`),t=this.$(`.new-chat-btn`),n=this.resultContext.get(`data`)||[],r=this.chatContext.get(`history`)||[];n.length>0?e?.classList.remove(`hidden`):e?.classList.add(`hidden`),r.length>0?t?.classList.remove(`hidden`):t?.classList.add(`hidden`)}newChat(){let e=this.$(`.new-chat-btn`);this.chatHandler.newChat(()=>e?.classList.add(`hidden`))}handleInput(e){let t=e.target,n=t.value,r=t.selectionStart||0;if(this.activeMode===`chat`){let e=this.mentionHandler.checkForMention(n,r);if(e.isMentioning&&(this.isMentioning=!0,this.mentionStartIndex=e.startIndex,this.mentionResults=this.mentionHandler.filterMentionResults(e.query),this.activeMentionIndex=this.mentionResults.length>0?0:-1,this.mentionResults.length>0)){this.renderMentions(),this.showMentions();return}}this.hideMentions(),this.isMentioning=!1;let i=n.trim().toLowerCase();if(!i){this.hideSuggestions();return}if(this.activeMode!==`search`){this.hideSuggestions();return}let a=this.searchContext.get(`history`)||[];this.suggestions=nt(a,i),this.activeSuggestionIndex=-1,this.suggestions.length>0?(this.renderSuggestions(i),this.showSuggestions()):this.hideSuggestions()}renderMentions(){let e=this.$(`.mentions`);e&&(e.innerHTML=`
        ...
        `,e.querySelectorAll(`.mention-item`).forEach((e,t)=>{e.onmousedown=e=>{e.preventDefault(),this.selectMention(this.mentionResults[t])},e.onmouseenter=()=>{this.activeMentionIndex=t,this.renderMentions()}}))}showMentions(){let e=this.$(`.mentions`),t=this.$(`.search-card`);e?.classList.remove(`hidden`),t?.classList.add(`has-mentions`)}hideMentions(){let e=this.$(`.mentions`),t=this.$(`.search-card`);e?.classList.add(`hidden`),t?.classList.remove(`has-mentions`),this.mentionResults=[],this.activeMentionIndex=-1}selectMention(e){let t=this.$(`textarea`);if(!t)return;let n=t.selectionStart||0,{newText:r,newCursorPosition:i}=this.mentionHandler.buildMentionText(t.value,this.mentionStartIndex,n,e.name);t.value=r,t.setSelectionRange(i,i),this.hideMentions(),this.isMentioning=!1,t.focus()}showSuggestions(){let e=this.$(`.suggestions`),t=this.$(`.search-card`);e?.classList.remove(`hidden`),t?.classList.add(`has-suggestions`)}hideSuggestions(){let e=this.$(`.suggestions`),t=this.$(`.search-card`);e?.classList.add(`hidden`),t?.classList.remove(`has-suggestions`)}renderSuggestions(e){let t=this.$(`.suggestions`);t&&(t.innerHTML=`
            <div class="suggestions-content">
                ${this.suggestions.map((t,n)=>{let{match:r,rest:i}=rt(t,e);return`
...
`;const k={catalogue:[`model_verbose_name`],service:[`service`],serviceCategory:[`serviceCategory`],agora:[`_sourceHost`],origin:[`origin`,`x_origin`,`x_home_partner_institution`,`x_home_university`,`x_participating_universities`,`x_host_university`,`x_university`,`x_university_origin`]};var yt=class extends i{selectedFilters;resultContext;filterContext;companyContext;metagoraContext;isCollapsed=!1;collapsedSections=new Set;sectionsInitialized=!1;constructor(){super(`plain-filter-widget`,vt),this.resultContext=this.useContext(m.RESULT,!0),this.filterContext=this.useContext(m.FILTER),this.companyContext=this.useContext(m.COMPANY),this.metagoraContext=this.useContext(m.METAGORA),this.selectedFilters=this.useState({mapping:k,filters:{}}),this.initiFilters()}initiFilters(){let e=this.filterContext.get();this.selectedFilters.set({mapping:k,filters:e?.filters||{}})}getAgoraNameFromHost(e){return(this.metagoraContext.get(`agoras`)||[]).find(t=>t.host===e)?.name||e}truncateText(e,t=30){return e.length<=t?e:e.substring(0,t)+`...`}updateAvailableFilters(){let e=this.resultContext.get()?.data||[],t=Object.values(k).flatMap(e=>e),n={service:[],origin:[],catalogue:[],serviceCategory:[],agora:[]};return t.map(t=>{e.map(e=>{let r=O(e,t),i=Object.keys(k).find(e=>k[e].includes(t));if(!i||![`service`,`origin`,`catalogue`,`serviceCategory`,`agora`].includes(i))return;let a=r.map(e=>e[t]);if(a=a.filter(e=>e),i===`origin`){let e=a.flatMap(e=>x(e));n[i].push(...e)}else if(i===`agora`){let e=a.map(e=>({label:this.getAgoraNameFromHost(e),value:e}));n[i].push(...e)}else n[i].push(...a);if(i===`agora`){let e=new Set;n[i]=n[i].filter(t=>e.has(t.value)?!1:(e.add(t.value),!0))}else n[i]=Array.from(new Set(n[i]))})}),n}clearFilters(){let e={mapping:k,filters:{}};this.selectedFilters.set(e),this.filterContext.set(e,!0)}toggleCollapse(){this.isCollapsed=!this.isCollapsed,this.$(`.filter-widget`)?.classList.toggle(`collapsed`,this.isCollapsed)}toggleSection(e){this.collapsedSections.has(e)?this.collapsedSections.delete(e):this.collapsedSections.add(e),this.render()}template(){if((this.resultContext.get()?.data||[]).length===0)return``;let e=this.updateAvailableFilters(),t=Object.values(e).flatMap(e=>e).length>0;t&&!this.sectionsInitialized&&(this.sectionsInitialized=!0,[`origin`,`service`,`catalogue`,`serviceCategory`,`agora`].forEach(t=>{e[t]&&e[t].length>1&&this.collapsedSections.add(t)}));let n=this.companyContext.get(`primaryColor`);n&&this.style.setProperty(`--primary-color`,n);let r=e.origin.length>1?this.html`
...
@media (max-width: 480px) {
    .ellipse {
...
}`,xt=class extends i{constructor(){super(`plain-intro-animation`,bt),setTimeout(()=>{let e=this.$(`.central-square`);e&&(e.style.opacity=`0`),setTimeout(()=>{this.style.opacity=`0`,setTimeout(()=>{this.remove()},1e3)},500)},3e3)}template(){return this.html`
            <div class="central-square">
                <section class="s_aupaeu_animated_background background-container" >
                    <div class="gradient-layer"></div>
                    <div class="ellipse ellipse-323"></div>
        ...
        `}};window.customElements.define(`plain-intro-animation`,xt);var St=`.plain-detail-modal-wrapper {
    pointer-events: none;
    position: fixed;
    top: 0;
    left: 0;
...
@media (max-width: 900px) {
    ...
    .modal-title {
                    ...
                    <div class="modal-content--top">
                        ...
                        <div class="modal-content--top-right">
                            <div class="image-item">
                                <div class="image-wrapper" style="background-image: url('${ee}')"></div>
                            </div>
                        </div>`:``}
                    </div>
        ...
        `}listeners(){let e=this.$(`.modal-overlay`),t=this.$(`.close-btn`);e&&(e.onclick=t=>{t.target===e&&this.close()}),t&&(t.onclick=()=>this.close())}};window.customElements.define(`plain-detail-modal`,Ct);var wt=`.plain-chat-window-wrapper {
    width: 100%;
    height: 100%;
...
}`;function A(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var j=A();function Tt(e){j=e}var M={exec:()=>null};function N(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(P.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var Et=(()=>{try{return!0}catch{return!1}})(),P={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`)},Dt=/^(?:[ \t]*(?:\n|$))+/,Ot=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,kt=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,F=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,At=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,jt=/(?:[*+-]|\d{1,9}[.)])/,Mt=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Nt=N(Mt).replace(/bull/g,jt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),Pt=N(Mt).replace(/bull/g,jt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ft=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,It=/^[^\n]+/,Lt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Rt=N(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,Lt).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),zt=N(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,jt).getRegex(),I=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,L=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Bt=N(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,L).replace(`tag`,I).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Vt=N(Ft).replace(`hr`,F).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,I).getRegex(),R={blockquote:N(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,Vt).getRegex(),code:Ot,def:Rt,fences:kt,heading:At,hr:F,html:Bt,lheading:Nt,list:zt,newline:Dt,paragraph:Vt,table:M,text:It},Ht=N(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,F).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,I).getRegex(),Ut={...R,lheading:Pt,table:Ht,paragraph:N(Ft).replace(`hr`,F).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,Ht).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,I).getRegex()},Wt={...R,html:N(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,L).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:M,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:N(Ft).replace(`hr`,F).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,Nt).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Gt=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Kt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,qt=/^( {2,}|\\)\n(?!\s*$)/,Jt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,z=/[\p{P}\p{S}]/u,B=/[\s\p{P}\p{S}]/u,Yt=/[^\s\p{P}\p{S}]/u,Xt=N(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,B).getRegex(),Zt=/(?!~)[\p{P}\p{S}]/u,Qt=/(?!~)[\s\p{P}\p{S}]/u,$t=/(?:[^\s\p{P}\p{S}]|~)/u,en=N(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,Et?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),tn=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,nn=N(tn,`u`).replace(/punct/g,z).getRegex(),rn=N(tn,`u`).replace(/punct/g,Zt).getRegex(),an=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,on=N(an,`gu`).replace(/notPunctSpace/g,Yt).replace(/punctSpace/g,B).replace(/punct/g,z).getRegex(),sn=N(an,`gu`).replace(/notPunctSpace/g,$t).replace(/punctSpace/g,Qt).replace(/punct/g,Zt).getRegex(),cn=N(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,Yt).replace(/punctSpace/g,B).replace(/punct/g,z).getRegex(),ln=N(/\\(punct)/,`gu`).replace(/punct/g,z).getRegex(),un=N(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),dn=N(L).replace(`(?:-->|$)`,`-->`).getRegex(),fn=N(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,dn).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),V=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,pn=N(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace(`label`,V).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),mn=N(/^!?\[(label)\]\[(ref)\]/).replace(`label`,V).replace(`ref`,Lt).getRegex(),hn=N(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,Lt).getRegex(),gn=N(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,mn).replace(`nolink`,hn).getRegex(),_n=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,H={_backpedal:M,anyPunctuation:ln,autolink:un,blockSkip:en,br:qt,code:Kt,del:M,emStrongLDelim:nn,emStrongRDelimAst:on,emStrongRDelimUnd:cn,escape:Gt,link:pn,nolink:hn,punctuation:Xt,reflink:mn,reflinkSearch:gn,tag:fn,text:Jt,url:M},vn={...H,link:N(/^!?\[(label)\]\((.*?)\)/).replace(`label`,V).getRegex(),reflink:N(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,V).getRegex()},yn={...H,emStrongRDelimAst:sn,emStrongLDelim:rn,url:N(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,_n).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:N(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,_n).getRegex()},bn={...yn,br:N(qt).replace(`{2,}`,`*`).getRegex(),text:N(yn.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},U={normal:R,gfm:Ut,pedantic:Wt},W={normal:H,gfm:yn,breaks:bn,pedantic:vn},xn={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Sn=e=>xn[e];function G(e,t){if(t){if(P.escapeTest.test(e))return e.replace(P.escapeReplace,Sn)}else if(P.escapeTestNoEncode.test(e))return e.replace(P.escapeReplaceNoEncode,Sn);return e}function Cn(e){try{e=encodeURI(e).replace(P.percentDecode,`%`)}catch{return null}return e}function wn(e,t){let n=e.replace(P.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(P.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(P.slashPipe,`|`);return n}function K(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function Tn(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function En(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function Dn(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
`).map(e=>{let t=e.match(n.other.beginningSpace);if(t===null)return e;let[r]=t;return r.length>=i.length?e.slice(i.length):e}).join(`
`)}var q=class{options;rules;lexer;constructor(e){this.options=e||j}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=t[0].replace(this.rules.other.codeRemoveIndent,``);return{type:`code`,raw:t[0],codeBlockStyle:`indented`,text:this.options.pedantic?e:K(e,`
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=Dn(e,t[3]||``,this.rules);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let t=K(e,`#`);(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:`heading`,raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:K(t[0],`
...
`):[],a={type:`table`,raw:t[0],header:[],align:[],rows:[]};if(n.length===r.length){for(let e of r)this.rules.other.tableAlignRight.test(e)?a.align.push(`right`):this.rules.other.tableAlignCenter.test(e)?a.align.push(`center`):this.rules.other.tableAlignLeft.test(e)?a.align.push(`left`):a.align.push(null);for(let e=0;e<n.length;e++)a.header.push({text:n[e],tokens:this.lexer.inline(n[e]),header:!0,align:a.align[e]});for(let e of i)a.rows.push(wn(e,a.header.length).map((e,t)=>({text:e,tokens:this.lexer.inline(e),header:!1,align:a.align[t]})));return a}}lheading(e){let t=this.rules.block.lheading.exec(e);if(t)return{type:`heading`,raw:t[0],depth:t[2].charAt(0)===`=`?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){let t=this.rules.block.paragraph.exec(e);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:`paragraph`,raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){let t=this.rules.block.text.exec(e);if(t)return{type:`text`,raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){let t=this.rules.inline.escape.exec(e);if(t)return{type:`escape`,raw:t[0],text:t[1]}}tag(e){let t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&this.rules.other.startATag.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:`html`,raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){let t=this.rules.inline.link.exec(e);if(t){let e=t[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(e)){if(!this.rules.other.endAngleBracket.test(e))return;let t=K(e.slice(0,-1),`\\`);if((e.length-t.length)%2==0)return}else{let e=Tn(t[2],`()`);if(e===-2)return;if(e>-1){let n=(t[0].indexOf(`!`)===0?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,n).trim(),t[3]=``}}let n=t[2],r=``;if(this.options.pedantic){let e=this.rules.other.pedanticHrefTitle.exec(n);e&&(n=e[1],r=e[3])}else r=t[3]?t[3].slice(1,-1):``;return n=n.trim(),this.rules.other.startAngleBracket.test(n)&&(n=this.options.pedantic&&!this.rules.other.endAngleBracket.test(e)?n.slice(1):n.slice(1,-1)),En(t,{href:n&&n.replace(this.rules.inline.anyPunctuation,`$1`),title:r&&r.replace(this.rules.inline.anyPunctuation,`$1`)},t[0],this.lexer,this.rules)}}reflink(e,t){let n;if((n=this.rules.inline.reflink.exec(e))||(n=this.rules.inline.nolink.exec(e))){let e=(n[2]||n[1]).replace(this.rules.other.multipleSpaceGlobal,` `),r=t[e.toLowerCase()];if(!r){let e=n[0].charAt(0);return{type:`text`,raw:e,text:e}}return En(n,r,n[0],this.lexer,this.rules)}}emStrong(e,t,n=``){let r=this.rules.inline.emStrongLDelim.exec(e);if(!(!r||r[3]&&n.match(this.rules.other.unicodeAlphaNumeric))&&(!(r[1]||r[2])||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=0,c=r[0][0]===`*`?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*e.length+n);(r=c.exec(t))!=null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i)continue;if(a=[...i].length,r[3]||r[4]){o+=a;continue}else if((r[5]||r[6])&&n%3&&!((n+a)%3)){s+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o+s);let t=[...r[0]][0].length,c=e.slice(0,n+r.index+t+a);if(Math.min(n,a)%2){let e=c.slice(1,-1);return{type:`em`,raw:c,text:e,tokens:this.lexer.inlineTokens(e)}}let l=c.slice(2,-2);return{type:`strong`,raw:c,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){let t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(this.rules.other.newLineCharGlobal,` `),n=this.rules.other.nonSpaceChar.test(e),r=this.rules.other.startingSpaceChar.test(e)&&this.rules.other.endingSpaceChar.test(e);return n&&r&&(e=e.substring(1,e.length-1)),{type:`codespan`,raw:t[0],text:e}}}br(e){let t=this.rules.inline.br.exec(e);if(t)return{type:`br`,raw:t[0]}}del(e){let t=this.rules.inline.del.exec(e);if(t)return{type:`del`,raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e){let t=this.rules.inline.autolink.exec(e);if(t){let e,n;return t[2]===`@`?(e=t[1],n=`mailto:`+e):(e=t[1],n=e),{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}url(e){let t;if(t=this.rules.inline.url.exec(e)){let e,n;if(t[2]===`@`)e=t[0],n=`mailto:`+e;else{let r;do r=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??``;while(r!==t[0]);e=t[0],n=t[1]===`www.`?`http://`+t[0]:t[0]}return{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}inlineText(e){let t=this.rules.inline.text.exec(e);if(t){let e=this.lexer.state.inRawBlock;return{type:`text`,raw:t[0],text:t[0],escaped:e}}}},J=class e{tokens;options;state;inlineQueue;tokenizer;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||j,this.options.tokenizer=this.options.tokenizer||new q,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:P,block:U.normal,inline:W.normal};this.options.pedantic?(t.block=U.pedantic,t.inline=W.pedantic):this.options.gfm&&(t.block=U.gfm,this.options.breaks?t.inline=W.breaks:t.inline=W.gfm),this.tokenizer.rules=t}static get rules(){return{block:U,inline:W}}static lex(t,n){return new e(n).lex(t)}static lexInline(t,n){return new e(n).inlineTokens(t)}lex(e){e=e.replace(P.carriageReturn,`
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${G(e,!0)}</code>`}br(e){return`<br>`}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:n}){let r=this.parser.parseInline(n),i=Cn(e);if(i===null)return r;e=i;let a=`<a href="`+e+`"`;return t&&(a+=` title="`+G(t)+`"`),a+=`>`+r+`</a>`,a}image({href:e,title:t,text:n,tokens:r}){r&&(n=this.parser.parseInline(r,this.parser.textRenderer));let i=Cn(e);if(i===null)return G(n);e=i;let a=`<img src="${e}" alt="${n}"`;return t&&(a+=` title="${G(t)}"`),a+=`>`,a}text(e){return`tokens`in e&&e.tokens?this.parser.parseInline(e.tokens):`escaped`in e&&e.escaped?e.text:G(e.text)}},On=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return``+e}image({text:e}){return``+e}br(){return``}checkbox({raw:e}){return e}},X=class e{options;renderer;textRenderer;constructor(e){this.options=e||j,this.options.renderer=this.options.renderer||new Y,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new On}static parse(t,n){return new e(n).parse(t)}static parseInline(t,n){return new e(n).parseInline(t)}parse(e){let t=``;for(let n=0;n<e.length;n++){let r=e[n];if(this.options.extensions?.renderers?.[r.type]){let e=r,n=this.options.extensions.renderers[e.type].call({parser:this},e);if(n!==!1||![`space`,`hr`,`heading`,`code`,`table`,`blockquote`,`list`,`html`,`def`,`paragraph`,`text`].includes(e.type)){t+=n||``;continue}}let i=r;switch(i.type){case`space`:t+=this.renderer.space(i);break;case`hr`:t+=this.renderer.hr(i);break;case`heading`:t+=this.renderer.heading(i);break;case`code`:t+=this.renderer.code(i);break;case`table`:t+=this.renderer.table(i);break;case`blockquote`:t+=this.renderer.blockquote(i);break;case`list`:t+=this.renderer.list(i);break;case`checkbox`:t+=this.renderer.checkbox(i);break;case`html`:t+=this.renderer.html(i);break;case`def`:t+=this.renderer.def(i);break;case`paragraph`:t+=this.renderer.paragraph(i);break;case`text`:t+=this.renderer.text(i);break;default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return t}parseInline(e,t=this.renderer){let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let e=this.options.extensions.renderers[i.type].call({parser:this},i);if(e!==!1||![`escape`,`html`,`link`,`image`,`strong`,`em`,`codespan`,`br`,`del`,`text`].includes(i.type)){n+=e||``;continue}}let a=i;switch(a.type){case`escape`:n+=t.text(a);break;case`html`:n+=t.html(a);break;case`link`:n+=t.link(a);break;case`image`:n+=t.image(a);break;case`checkbox`:n+=t.checkbox(a);break;case`strong`:n+=t.strong(a);break;case`em`:n+=t.em(a);break;case`codespan`:n+=t.codespan(a);break;case`br`:n+=t.br(a);break;case`del`:n+=t.del(a);break;case`text`:n+=t.text(a);break;default:{let e=`Token with "`+a.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}},Z=class{options;block;constructor(e){this.options=e||j}static passThroughHooks=new Set([`preprocess`,`postprocess`,`processAllTokens`,`emStrongMask`]);static passThroughHooksRespectAsync=new Set([`preprocess`,`postprocess`,`processAllTokens`]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(){return this.block?J.lex:J.lexInline}provideParser(){return this.block?X.parse:X.parseInline}},Q=new class{defaults=A();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=X;Renderer=Y;TextRenderer=On;Lexer=J;Tokenizer=q;Hooks=Z;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case`table`:{let e=r;for(let r of e.header)n=n.concat(this.walkTokens(r.tokens,t));for(let r of e.rows)for(let e of r)n=n.concat(this.walkTokens(e.tokens,t));break}case`list`:{let e=r;n=n.concat(this.walkTokens(e.items,t));break}default:{let e=r;this.defaults.extensions?.childTokens?.[e.type]?this.defaults.extensions.childTokens[e.type].forEach(r=>{let i=e[r].flat(1/0);n=n.concat(this.walkTokens(i,t))}):e.tokens&&(n=n.concat(this.walkTokens(e.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(e=>{let n={...e};if(n.async=this.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach(e=>{if(!e.name)throw Error(`extension name required`);if(`renderer`in e){let n=t.renderers[e.name];n?t.renderers[e.name]=function(...t){let r=e.renderer.apply(this,t);return r===!1&&(r=n.apply(this,t)),r}:t.renderers[e.name]=e.renderer}if(`tokenizer`in e){if(!e.level||e.level!==`block`&&e.level!==`inline`)throw Error(`extension level must be 'block' or 'inline'`);let n=t[e.level];n?n.unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&(e.level===`block`?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:e.level===`inline`&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}`childTokens`in e&&e.childTokens&&(t.childTokens[e.name]=e.childTokens)}),n.extensions=t),e.renderer){let t=this.defaults.renderer||new Y(this.defaults);for(let n in e.renderer){if(!(n in t))throw Error(`renderer '${n}' does not exist`);if([`options`,`parser`].includes(n))continue;let r=n,i=e.renderer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n||``}}n.renderer=t}if(e.tokenizer){let t=this.defaults.tokenizer||new q(this.defaults);for(let n in e.tokenizer){if(!(n in t))throw Error(`tokenizer '${n}' does not exist`);if([`options`,`rules`,`lexer`].includes(n))continue;let r=n,i=e.tokenizer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.tokenizer=t}if(e.hooks){let t=this.defaults.hooks||new Z;for(let n in e.hooks){if(!(n in t))throw Error(`hook '${n}' does not exist`);if([`options`,`block`].includes(n))continue;let r=n,i=e.hooks[r],a=t[r];Z.passThroughHooks.has(n)?t[r]=e=>{if(this.defaults.async&&Z.passThroughHooksRespectAsync.has(n))return(async()=>{let n=await i.call(t,e);return a.call(t,n)})();let r=i.call(t,e);return a.call(t,r)}:t[r]=(...e)=>{if(this.defaults.async)return(async()=>{let n=await i.apply(t,e);return n===!1&&(n=await a.apply(t,e)),n})();let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.hooks=t}if(e.walkTokens){let t=this.defaults.walkTokens,r=e.walkTokens;n.walkTokens=function(e){let n=[];return n.push(r.call(this,e)),t&&(n=n.concat(t.call(this,e))),n}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return J.lex(e,t??this.defaults)}parser(e,t){return X.parse(e,t??this.defaults)}parseMarkdown(e){return(t,n)=>{let r={...n},i={...this.defaults,...r},a=this.onError(!!i.silent,!!i.async);if(this.defaults.async===!0&&r.async===!1)return a(Error(`marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise.`));if(typeof t>`u`||t===null)return a(Error(`marked(): input parameter is undefined or null`));if(typeof t!=`string`)return a(Error(`marked(): input parameter is of type `+Object.prototype.toString.call(t)+`, string expected`));if(i.hooks&&(i.hooks.options=i,i.hooks.block=e),i.async)return(async()=>{let n=i.hooks?await i.hooks.preprocess(t):t,r=await(i.hooks?await i.hooks.provideLexer():e?J.lex:J.lexInline)(n,i),a=i.hooks?await i.hooks.processAllTokens(r):r;i.walkTokens&&await Promise.all(this.walkTokens(a,i.walkTokens));let o=await(i.hooks?await i.hooks.provideParser():e?X.parse:X.parseInline)(a,i);return i.hooks?await i.hooks.postprocess(o):o})().catch(a);try{i.hooks&&(t=i.hooks.preprocess(t));let n=(i.hooks?i.hooks.provideLexer():e?J.lex:J.lexInline)(t,i);i.hooks&&(n=i.hooks.processAllTokens(n)),i.walkTokens&&this.walkTokens(n,i.walkTokens);let r=(i.hooks?i.hooks.provideParser():e?X.parse:X.parseInline)(n,i);return i.hooks&&(r=i.hooks.postprocess(r)),r}catch(e){return a(e)}}}onError(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+G(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function $(e,t){return Q.parse(e,t)}$.options=$.setOptions=function(e){return Q.setOptions(e),$.defaults=Q.defaults,Tt($.defaults),$},$.getDefaults=A,$.defaults=j,$.use=function(...e){return Q.use(...e),$.defaults=Q.defaults,Tt($.defaults),$},$.walkTokens=function(e,t){return Q.walkTokens(e,t)},$.parseInline=Q.parseInline,$.Parser=X,$.parser=X.parse,$.Renderer=Y,$.TextRenderer=On,$.Lexer=J,$.lexer=J.lex,$.Tokenizer=q,$.Hooks=Z,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,X.parse,J.lex;var kn=class extends i{chatContext;resultContext;companyContext;isLoading=!1;streamingMessage=``;showFetchingLabel=!1;isFadingOut=!1;fadeOutTimer=null;constructor(){super(`plain-chat-window`,wt),this.chatContext=this.useContext(m.CHAT,!0),this.resultContext=this.useContext(m.RESULT,!0),this.companyContext=this.useContext(m.COMPANY)}template(){let e=this.chatContext.get(`history`)||[],t=this.resultContext.get(`data`)||[],n=this.companyContext.get(`name`)||`the Agora`,r=t.length>0;return this.html`
...
`)),this.companyContext=this.useContext(m.COMPANY),this.configContext=this.useContext(m.CONFIG),this.serviceContext=this.useContext(m.SERVICE),this.resultContext=this.useContext(m.RESULT),this.modalContext=this.useContext(m.MODAL),this.chatContext=this.useContext(m.CHAT),this.metagoraContext=this.useContext(m.METAGORA),this.signals=this.useSignals(),this.initializeHandlers(),this.init()}template(){let e=this.companyContext.get(`primaryColor`)||`#000`;return this.html`
            ...
            <header class="mobile-header">
                ${this.configContext.get(`VISIBLE_LOGO`)?this.html`<plain-logo></plain-logo>`:``}
                <button 
                    class="hamburger-btn" 
                    title="Open menu"
...
`}
        ...
        `}initializeHandlers(){this.contextHandler=new Rn({configContext:this.configContext,companyContext:this.companyContext,serviceContext:this.serviceContext,modalContext:this.modalContext,metagoraContext:this.metagoraContext,getAttribute:e=>this.getAttribute(e),hasAttribute:e=>this.hasAttribute(e)}),this.layoutHandler=new zn({resultContext:this.resultContext,chatContext:this.chatContext,$:e=>this.$(e)},{getCurrentMode:()=>this.currentMode,setCurrentMode:e=>{this.currentMode=e},getPanelHandler:()=>this.panelHandler}),this.panelHandler=new Bn({resultContext:this.resultContext,$:e=>this.$(e)})}async init(){await this.contextHandler.initializeAll()}afterRender(){let e=this.configContext.get(`MAX_HEIGHT`);if(e){let t=this.shadowRoot?.querySelector(`.agora-app-wrapper`);t&&(t.style.maxHeight=e)}}connectors(){this.setupSignalConnections(),this.panelHandler.setupEventListeners(),this.layoutHandler.initializeLayout()}setupSignalConnections(){let e=this.$(`plain-agora-input`),t=this.$(`plain-chat-window`);e&&(this.signals.connect(e,C.RESULTS_FETCHED,e=>this.layoutHandler.updateVisibility(e)),this.signals.connect(e,C.RESULTS_CLEARED,()=>this.layoutHandler.updateVisibility(null))),t&&(this.signals.connect(e,C.CHAT_USER_MESSAGE,()=>{t.handleUserMessage()}),this.signals.connect(e,C.CHAT_MESSAGE_CHUNK,e=>{t.handleMessageChunk(e)}),this.signals.connect(e,C.CHAT_MESSAGE_COMPLETE,()=>{t.handleMessageComplete()}),this.signals.connect(e,C.CHAT_FETCHING_RESULTS,e=>{t.handleFetchingResults(e)}),this.signals.connect(e,C.CHAT_STARTED,()=>{this.layoutHandler.showChatWindow()}),this.signals.connect(e,C.NEW_CHAT,()=>{this.layoutHandler.resetToInitialState(),t.render()}),this.signals.connect(e,C.MODE_SWITCH,e=>{this.layoutHandler.handleModeSwitch(e)}))}};window.customElements.define(`${w.IS_METAGORA?`metagora`:`agora`}-app-v2`,Vn);